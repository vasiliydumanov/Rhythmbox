...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftMLP/SwiftMLP.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TensorSwift/TensorSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/swix/swix.framework"
fi
